...
public class HTCCCalibrationApp extends FCApplication implements CalibrationConstantsListener,ChangeListener {
    ...
    public HTCCCalibrationEngine[] engines = {
            new HTCCGainEventListener(),
            new HTCCStatusEventListener()
    };

    public final int   GAIN  = 0;
    public final int STATUS  = 1;
    
    String[] names = {"/calibration/htcc/gains","/calibration/htcc/status"};
    ...
    public HTCCCalibrationApp(String name , HTCCPixels[] ftofPix) {
        super(name, ftofPix);       
     } 
    ...
    public HTCCCalibrationEngine getSelectedEngine() {
        
        HTCCCalibrationEngine engine = engines[GAIN];
    ...
    public class HTCCGainEventListener extends HTCCCalibrationEngine {
        
        int is1,is2;
        
        HTCCGainEventListener(){};
        ...
        public void init(int is1, int is2) {
            ...
            calib.setName("/calibration/htcc/gains");
...
/*            
    ...
    public void updateDetectorView(DetectorShape2D shape) {
        HTCCCalibrationEngine engine = getSelectedEngine();
