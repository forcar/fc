...
public class HTCCScalersApp extends FCEpics {
        ...
        HTCCScalersApp(String name, String det) {
            super(name, det);
        }  
        ...
        public void startEPICS() {
        	System.out.println("HTCCScalersApp: Connect to EPICS Channel Access");
        	clearMaps(); nfifo=0;
            createContext();
        ...
        public void stopEPICS() {
        	System.out.println("HTCCScalersApp: Disconnect from EPICS Channel Access");
