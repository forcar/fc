...
public class FCCLASDecoder3 {
    ...
    public FCCLASDecoder3(){    
        System.out.println("***************");
        System.out.println("*FCCLASDecoder3*");
        System.out.println("***************");
    ...
    public static FCCLASDecoder3 createDecoder(){
        FCCLASDecoder3 decoder = new FCCLASDecoder3();
        return decoder;
    }
    ...
    public void initEvent(DataEvent event){
        ...
        if(event instanceof EvioDataEvent){
            try {
                ...
                this.setRunNumber(runNumberCoda>0?runNumberCoda:7777);
