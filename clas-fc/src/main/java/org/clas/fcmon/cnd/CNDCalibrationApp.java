...
public class CNDCalibrationApp extends FCApplication implements CalibrationConstantsListener,ChangeListener {
    ...
    public CNDCalibrationEngine[] engines = {
    ...
    public CNDCalibrationApp(String name , CNDPixels[] ftofPix) {
        super(name, ftofPix);       
     } 
    ...
    public CNDCalibrationEngine getSelectedEngine() {
        ...
        CNDCalibrationEngine engine = engines[HV];
    ...
    public class FTOFHVEventListener extends CNDCalibrationEngine {
    ...
    private class FTOFStatusEventListener extends CNDCalibrationEngine {
