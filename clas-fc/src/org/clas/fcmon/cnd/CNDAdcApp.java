...
//        canvas.setStatBoxFontSize(12);
        ...
        h1a = cndPix[ilm].strips.hmap2.get("H2_a_Hist").get(is,1,0).projectionY(); h1a.setTitleX("Sector "+is+" L PMT");  h1a.setFillColor(col0);  
        h1b = cndPix[ilm].strips.hmap2.get("H2_a_Hist").get(is,2,0).projectionY(); h1b.setTitleX("Sector "+is+" R PMT" ); h1b.setFillColor(col0);  
        h1c = cndPix[ilm].strips.hmap2.get("H2_a_Hist").get(is,0,0).projectionY(); h1c.setTitleX("Sector "+is+" PADDLE" ); h1c.setFillColor(col1);  
        ...
        h1a = cndPix[ilm].strips.hmap2.get("H2_a_Hist").get(is,1,0).sliceY(ics); h1a.setTitleX("L PMT "+(ic+1)+" ADC");   h1a.setFillColor(col0);  
        h1b = cndPix[ilm].strips.hmap2.get("H2_a_Hist").get(is,2,0).sliceY(ics); h1b.setTitleX("R PMT "+(ic+1)+" ADC" ); h1b.setFillColor(col0);  
        h1c = cndPix[ilm].strips.hmap2.get("H2_a_Hist").get(is,0,0).sliceY(ics); h1c.setTitleX("GMEAN PADDLE "+(ic+1));      h1c.setFillColor(col2);  
