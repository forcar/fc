...
//        canvas.setStatBoxFontSize(12);
        ...
        h1a = ctofPix[ilm].strips.hmap2.get("H2_t_Hist").get(is,1,0).sliceY(ic); h1a.setTitleX("UP PMT "+(ic+1)+" TDC");   h1a.setFillColor(col0);  
        h1b = ctofPix[ilm].strips.hmap2.get("H2_t_Hist").get(is,2,0).sliceY(ic); h1b.setTitleX("DN PMT "+(ic+1)+" TDC" ); h1b.setFillColor(col0);  
        h1c = ctofPix[ilm].strips.hmap2.get("H2_t_Hist").get(is,0,0).sliceY(ic); h1c.setTitleX("TDIF PADDLE "+(ic+1));       h1c.setFillColor(col2);  
