 ...
 * @author gavalian
 */
public class FCDetectorEventDecoder {
    ...
    public FCDetectorEventDecoder(boolean development){
        if(development==true){
            this.initDecoderDev();
        } else {
            this.initDecoder();
...
//                System.out.println("SIZE= "+data.getTDCSize());
