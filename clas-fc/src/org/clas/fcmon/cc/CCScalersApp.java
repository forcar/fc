...
public class CCScalersApp extends FCEpics {
        ...
        public void startEPICS() {
            System.out.println("CCScalersApp: Connect to EPICS Channel Access");
            clearMaps(); nfifo=0;
            createContext();
        ...
        public void stopEPICS() {
            System.out.println("CCScalersApp: Disconnect from EPICS Channel Access");
        ...
        public void initFifos() {
            System.out.println("CCScalersApp.initFifos():");
            for (int is=is1; is<is2 ; is++) {
                for (int il=1; il<layMap.get(detName).length+1 ; il++) {
